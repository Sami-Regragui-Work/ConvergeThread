    ...
    public function poll()
    {
        ...
        if ($user->isOwner()) {
            return response()->json([
                ...
                'invitations' => optional(Invitation::query()->max('created_at'))?->toIso8601String(),
        ...
        return response()->json([
            ...
            'invitations' => optional(Invitation::query()->where('tenant_id', $tenantId)->max('created_at'))?->toIso8601String(),
