        ...
        <template x-for="(attachment, ai) in message.attachments" :key="'att-' + (attachment.id || ai)">
            <div class="relative group/att overflow-hidden rounded-xl border border-white/10 shrink-0 bg-black/40"
                :class="{
                    ...
                    'w-64 sm:w-72': attachment.is_audio,
                ...
                <button type="button" x-show="attachment.is_video && attachmentDisplayUrl(attachment)" x-cloak
                    ...
                    <video :src="attachmentDisplayUrl(attachment)" class="h-full w-full object-cover pointer-events-none" muted playsinline preload="metadata"></video>
                ...
                {{-- Audio --}}
                <div x-show="attachment.is_audio" x-cloak class="p-3 space-y-2">
                    <audio class="w-full" controls preload="metadata"
                        :src="attachmentDisplayUrl(attachment) || undefined"></audio>
