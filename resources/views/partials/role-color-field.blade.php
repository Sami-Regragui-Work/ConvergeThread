<div>
    ...
    <div class="flex items-center gap-3">
        ...
        <input type="text" id="role-color-hex" name="color" value="{{ old('color', $color ?? '#94a3b8') }}"
            ...
            class="flex-1 bg-surface-300 border border-white/10 text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 transition font-mono"
