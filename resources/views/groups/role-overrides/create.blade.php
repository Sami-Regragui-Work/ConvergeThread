@extends('layouts.app')
@section('title', 'New Role Override')

@section('content')
    <div class="max-w-lg mx-auto">
        <h1 class="text-xl font-bold text-white mb-6">New Role Override</h1>

        <div class="bg-surface-200 border border-white/5 rounded-2xl p-8 shadow-xl">
            <form method="POST" action="{{ url('/groups/' . $group->id . '/role-overrides') }}" class="space-y-5">
                @csrf
